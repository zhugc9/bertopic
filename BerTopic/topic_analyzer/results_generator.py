...
class ResultsGenerator:
    ...
    def generate_timeline_analysis(self, metadata_df: pd.DataFrame, topic_model: BERTopic):
        """生成时间线分析"""
        try:
    ...
    def generate_enhanced_summary(self, topic_model: BERTopic, documents: List[str], metadata_df: Optional[pd.DataFrame] = None):
        ...
        try:
            ...
            # 保存增强版摘要
            enhanced_path = self.results_paths['summary_enhanced']
