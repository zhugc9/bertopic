...
class DynamicTopicEvolution:
    ...
    def analyze_dynamic_topics(self,
        ...
        try:
            ...
            evolution_tuning = self.analysis_config.get('evolution_tuning', True)
            global_tuning = self.analysis_config.get('global_tuning', True)
            ...
            topics_over_time = topic_model.topics_over_time(
                ...
                evolution_tuning=evolution_tuning,  # 启用演化调优（可配置）
                global_tuning=global_tuning         # 启用全局调优（可配置）
            )
    ...
    def save_evolution_analysis(self,
        ...
        Returns:
            保存的文件路径
        """
        output_path = Path(self.results_paths['evolution_file'])
